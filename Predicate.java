...
class NpList{
    ...
    public void NpGenerator(String value, String c_type, String col_value, String pos_tag, String ptype) {
		...
		str = "";
		str = value + " :- " + pos_tag + " : " + "(pkey_retriever:<" + c_type + "," + ptype + "> " + col_value + ":" + c_type + ")";
...
class Seed{
    ...
    public void Preposition(String prep, String pred1, String pred2, String ptype) {
    	...
    	seed_prep.add(entry);
		entry = "";
		entry += prep + " :- PP/NP : (lambda $0:<e,e> (lambda $1:e (" + pred1 + " ($0 $1))))";
    	seed_prep.add(entry);
    	entry = "";
        entry += prep + " :- PP/NP : (lambda $0:e (lambda $1:"+ ptype + " (" + pred2 + " $1 $0)))";//here type 4 will be used
        entry = "";
        entry += prep + " :- PP/NP : (lambda $0:<e,e> (lambda $1:"+ ptype + " (lambda $2:e (" + pred2 + " $1 ($0 $2)))))";
        seed_prep.add(entry);
    }
